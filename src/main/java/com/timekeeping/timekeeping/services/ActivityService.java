...
public class ActivityService {
    ...
    public void sendEmail(Activity activity, long id, String fullUrl) {
        for (Account acc : accountRepository.findAllEmployees()) {
            ...
            try {
                String content = """
                    ...
                    <a href="%s/%d">Confirm Your Attendance</a> <br/><br/>
                    ...
                    Goppy
                """;
                content = String.format(content, acc.getFullName(), activity.getActivityName(), activity.getStartTime(), activity.getLocation(), activity.getDescription(), activity.getStartTime().toLocalDate(), activity.getStartTime().toLocalTime(), activity.getLocation(), fullUrl, id);
